...
4. Search shuffled edge origins and destinations for a valid fixed path and derive the applicable origin segment. Exclude occupied origins, first downstream road cells reserved by committed intersection crossings, and intersections with active emergency preemption claims.
