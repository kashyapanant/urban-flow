...
The browser frontend files are still part of the remaining Phase 1 work. Before that, the `P1-ENG-04` through `P1-ENG-07` congestion-stabilization sequence prevents long-running demo simulations from saturating into permanent gridlock.
